...
void CutCG_add_cuts_model_CG_byZ_parallel( CutCG *ccg, const CGraph *cgraph, int cutType, LinearProgram *lp, const Instance *inst, double timeLeft,   double maxcuts, int nround, int horizon);
